...
function RegisterForm() {
  ...
  const validateAll = () => {
    ...
    const usernameError = form.username === '' ? 'Username không được để trống' : validateUsername(form.username);
    if (usernameError) newErrors.username = usernameError;
    
    const emailError = form.email === '' ? 'Email không được để trống' : validateEmail(form.email);
    if (emailError) newErrors.email = emailError;
    
    const passwordError = form.password === '' ? 'Password không được để trống' : validatePassword(form.password);
    if (passwordError) newErrors.password = passwordError;
    
    const confirmError = form.confirm === '' ? 'Confirm password không được để trống' : validateConfirm(form.confirm, form.password);
  ...
  const isValid = useMemo(() => {
    ...
    const allFilled = form.username && form.email && form.password && form.confirm;
    const noErrors = !errors.username && !errors.email && !errors.password && !errors.confirm;
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    style={{
                      ...
                      borderWidth: touched.username && errors.username ? '2px' : '1px'
                    }}
                  />
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    style={{
                      ...
                      borderWidth: touched.password && errors.password ? '2px' : '1px'
                    }}
                  />
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    style={{
                      borderColor: touched.confirm && errors.confirm ? '#dc3545' : '',
                      borderWidth: touched.confirm && errors.confirm ? '2px' : '1px'
                    }}
                  />
          ...
          <Card>
            <Card.Body>
              ...
              <div style={{ lineHeight: 2 }}>
                ...
                <p style={{ color: '#28a745', fontSize: '14px', marginTop: 16 }}>
